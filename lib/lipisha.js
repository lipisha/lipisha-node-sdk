...
function Lipisha(apiKey, apiSignature, environment) {
     ...
     * Request Money
     *
     * - account_number (String): Transaction account number to receive the payment
     * - mobile_number (String): Telephone number
     * - method (String): Payment method to be used to carry out the transaction e.g. Paybill (M-PESA) or Paybill (Airtel Money)
     * - amount (Number): Amount of money to be paid by the customer
     * - reference (String): Unique identifier for the mobile transaction
     *
     * http://developer.lipisha.com/index.php/app/launch/api_request_money
     **/
    this.request_money = function(account_number, mobile_number, method, amount, reference, callback) {
        var parameters = {
            "account_number": account_number,
            "mobile_number": mobile_number,
            "method": method,
        ...
        this.execute("request_money", parameters, function(err, response) {
            return callback(err, response);
        });
    };
    ...
    this.create_payment_account = function(transaction_account_type, transaction_account_name, transaction_account_manager, callback) {
        var parameters = {
            "transaction_account_type": transaction_account_type,
...
/**
 * Exports Lipisha as a contructor instead of an object
 * usage client =  new Lipisha(options) instead of lipisha.Lipisha(options)
 * @type {[type]}
 */
module.exports = Lipisha;
