...
function Lipisha (apiKey, apiSignature, environment) {
    ...
    **/
    this.send_airtime = function(account_number, mobile_number, amount, network, callback) {
        parameters = {"account_number" : account_number, "mobile_number" : mobile_number, "amount" : amount, "network" : network};
    ...
    **/
    this.create_user = function(full_name, role, mobile_number, email, user_name, password, callback) {
        parameters = {"full_name" : full_name, "role" : role, "mobile_number" : mobile_number, "email" : email, "user_name" : user_name, "password" : password};
    ...
    **/
    this.update_user = function(full_name, role, mobile_number, email, user_name, callback) {
        parameters = {"full_name" : full_name, "role" : role, "mobile_number" : mobile_number, "email" : email, "user_name" : user_name};
    ...
    *
    * - transaction_account_type (String): Transaction account type
    ...
    **/
    this.create_payment_account = function(transaction_account_type, transaction_account_name, transaction_account_manager, callback) {
        parameters = {"transaction_account_type" : transaction_account_type, "transaction_account_name" : transaction_account_name, "transaction_account_manager" : transaction_account_manager};
    ...
    * - transaction_amount_minimum (String): Transaction amount minimum
    * - transaction_amount_maximum (String): Transaction amount maximum
    ...
    **/
    this.get_transactions = function(transaction, transaction_type, transaction_method, transaction_date_start, transaction_date_end, transaction_account_name, transaction_account_number, transaction_reference, transaction_amount_minimum, transaction_amount_maximum, transaction_status, transaction_name, transaction_mobile_number, transaction_email, limit, offset, callback) {
        parameters = {"transaction" : transaction, "transaction_type" : transaction_type, "transaction_method" : transaction_method, "transaction_date_start" : transaction_date_start, "transaction_date_end" : transaction_date_end, "transaction_account_name" : transaction_account_name, "transaction_account_number" : transaction_account_number, "transaction_reference" : transaction_reference, "transaction_amount_minimum" : transaction_amount_minimum, "transaction_amount_maximum" : transaction_amount_maximum, "transaction_status" : transaction_status, "transaction_name" : transaction_name, "transaction_mobile_number" : transaction_mobile_number, "transaction_email" : transaction_email, "limit" : limit, "offset" : offset};
    ...
    * - customer_payments_minimum (String): Customer payments minimum
    * - customer_payments_maximum (String): Customer payments maximum
    * - customer_total_spent_minimum (String): Customer total spent minimum
    * - customer_total_spent_maximum (String): Customer total spent maximum
    * - customer_average_spent_minimum (String): Customer average spent minimum
    * - customer_average_spent_maximum (String): Customer average spent maximum
    * - limit (String): Limit
    * - offset (String): Offset
    * - callback (Function): function called with error as first argument and response object as second argument
    * 
    ...
    **/
    this.get_customers = function(customer_name, customer_mobile_number, customer_email, customer_first_payment_from, customer_first_payment_to, customer_last_payment_from, customer_last_payment_to, customer_payments_minimum, customer_payments_maximum, customer_total_spent_minimum, customer_total_spent_maximum, customer_average_spent_minimum, customer_average_spent_maximum, limit, offset, callback) {
        parameters = {"customer_name" : customer_name, "customer_mobile_number" : customer_mobile_number, "customer_email" : customer_email, "customer_first_payment_from" : customer_first_payment_from, "customer_first_payment_to" : customer_first_payment_to, "customer_last_payment_from" : customer_last_payment_from, "customer_last_payment_to" : customer_last_payment_to, "customer_payments_minimum" : customer_payments_minimum, "customer_payments_maximum" : customer_payments_maximum, "customer_total_spent_minimum" : customer_total_spent_minimum, "customer_total_spent_maximum" : customer_total_spent_maximum, "customer_average_spent_minimum" : customer_average_spent_minimum, "customer_average_spent_maximum" : customer_average_spent_maximum, "limit" : limit, "offset" : offset};
    ...
    **/
    this.authorize_card_transaction = function(account_number, card_number, address1, address2, expiry, name, country, state, zip, security_code, amount, currency, callback) {
        parameters = {"account_number" : account_number, "card_number" : card_number, "address1" : address1, "address2" : address2, "expiry" : expiry, "name" : name, "country" : country, "state" : state, "zip" : zip, "security_code" : security_code, "amount" : amount, "currency" : currency};
    ...
    **/
    this.reverse_card_transaction = function(transaction_index, transaction_reference, callback) {
        parameters = {"transaction_index" : transaction_index, "transaction_reference" : transaction_reference};
